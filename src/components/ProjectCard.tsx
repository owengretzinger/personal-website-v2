...
export default function ProjectCard({
  ...
  return (
    <div className="relative w-full md:h-[251px] md:min-h-[251px] md:w-[300px] md:min-w-[300px] rounded-[10px] border border-lightGrey text-sm transition-colors hover:bg-lightGrey/10 dark:hover:bg-lightGrey/30">
      <div className="flex flex-col gap-[20px] px-[20px] py-[20px]">
        ...
        <div className="flex justify-between text-grey">
          ...
          <Link
            ...
            className="group/link relative z-10 flex items-center gap-[4px] text-grey transition-all hover:text-darkTeal"
          >
            <IconBrandGithub
              size={19}
              stroke={1.25}
        ...
        <div className="flex flex-col gap-[6px]">
          <Link
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="group/link flex items-center gap-[2px] font-semibold text-black transition-all hover:text-darkTeal"
          >

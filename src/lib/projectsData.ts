export const projects = {
  ...
  "Jazz Musician Website": {
    ...
    image: "/project-images/jazz-musician-website.png",
    description:
  ...
  "Simple Terms": {
    title: "Simple Terms",
    image: "/project-images/simple-terms.png",
    description:
  ...
  "Server Insights": {
    ...
    image: "/project-images/server-insights.png",
    description:
  ...
  "Triangle Ball": {
    title: "Triangle Ball",
    image: "/project-images/triangle-ball.png",
    description:
